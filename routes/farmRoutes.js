...
router.delete('/:id', authMiddleware.authenticateUser, farmController.deleteFarm);
...
router.put('/location/:id', authMiddleware.authenticateUser, farmController.updateFarmLocation);
